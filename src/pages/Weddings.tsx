    ...
    <div className="min-h-screen bg-[#fffcfc] overflow-hidden">
      ...
      <div className="relative h-[82vh] md:h-[88vh] lg:h-[92vh] overflow-hidden">
        <div 
          ...
          style={{ backgroundImage: 'url("/images/heroes/weddings-hero.webp")' }}
        />
        <div className="absolute inset-0 bg-black/30" />
        <PageHeading
          text="Weddings"
          subtextBelow="Your wedding day, styled to perfection"
        />
        <div className="absolute inset-0 flex items-center justify-center text-center px-4 hidden">
          <div className="max-w-4xl">
            ...
            <p className="font-light text-lg md:text-xl text-white/90 max-w-2xl mx-auto leading-relaxed animate-fade-in-up delay-200">
              Your love story, beautifully told. We design weddings that are as unique as the couple they celebrate, blending romance, elegance, and personal touches.
            </p>
          </div>
        </div>
      </div>
        ...
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <div className="space-y-8 animate-fade-in-up delay-200">
            <p className="text-gray-600 leading-loose font-light text-lg md:text-xl">
              Whether you envision a barefoot beach ceremony or a grand ballroom reception, our wedding styling is dedicated to bringing your vision to life. We focus on cohesive design, from the floral arrangements to the table settings, creating a seamless flow throughout the day.
            </p>
            <p className="text-gray-600 leading-loose font-light text-lg md:text-xl">
              We believe that every detail matters. Our team works tirelessly to ensure that your wedding day is not only visually stunning but also a true reflection of your love and commitment.
            </p>
          </div>
      ...
      <div className="bg-[#f8f5f2] py-24">
        <div className="max-w-[1400px] mx-auto px-6">
          <div className="text-center mb-16">
            <h3 className="font-serif text-3xl md:text-4xl text-gray-900 mb-4">Wedding Inspiration</h3>
            ...
            <div className="space-y-8">
              ...
              <ul className="space-y-4">
                {[
                  ...
                  "Reception table styling & centerpieces",
