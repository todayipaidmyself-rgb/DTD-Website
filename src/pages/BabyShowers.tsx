...
export default function BabyShowers() {
  ...
  return (
    <div className="min-h-screen bg-[#fffcfc] overflow-hidden">
      <Helmet>
        <title>Luxury Baby Showers | Dress That Day Cyprus</title>
        <meta name="description" content="Elegant baby shower styling in Cyprus. Welcoming new life with sophisticated decor, bespoke themes, and a touch of magic." />
      </Helmet>
        ...
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <div className="space-y-8 animate-fade-in-up delay-200">
            <p className="text-gray-600 leading-loose font-light text-lg md:text-xl">
              From pastel palettes to neutral tones, our baby shower styling is all about softness and elegance. We incorporate delicate florals, plush textures, and charming details to create a warm, inviting atmosphere.
            </p>
            <p className="text-gray-600 leading-loose font-light text-lg md:text-xl">
              Whether you prefer a classic tea party or a modern brunch, we design a setting that feels intimate and special, perfect for sharing advice, gifts, and love.
            </p>
          </div>
      ...
      <div className="bg-[#f8f5f2] py-24">
        <div className="max-w-[1400px] mx-auto px-6">
          <div className="text-center mb-16">
            <h3 className="font-serif text-3xl md:text-4xl text-gray-900 mb-4">Sweet Beginnings</h3>
      ...
      <div className="relative py-32 bg-[#1a1a1a] text-white text-center px-6">
        <div className="max-w-3xl mx-auto space-y-8">
          ...
          <p className="text-gray-400 font-light text-lg">
            Let us create a beautiful welcome for your little one.
          </p>
          <button 
